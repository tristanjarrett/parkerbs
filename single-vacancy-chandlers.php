	...
	<div class="pbs-breadcrumb">
		<nav class="container-fluid">
			<ul>
				...
				<li>/</li>
				<li><a href="<?php echo site_url() . '/chandlers-vacancies'; ?>">Vacancies</a></li>
				<li>/</li>
			...
			<div class="row">
						...
						<form action="<?php the_permalink(); ?>" method="post" enctype="multipart/form-data">
						  ...
						  <div class="form-group">
							...
							<div class="text-right">
								...
								<button type="submit" class="btn btn-chandlers">Submit Application</button>
							</div>
				...
				<div class="col-lg-3">
					<div class="pbs-sidebar">
						<h4 class="text-center mb-3 pbs-font pbs-chandlers-heading">More Vacancies</h4>
						<ul>
							<?php
				       $args = array(
								 'post_type' => 'vacancy',
