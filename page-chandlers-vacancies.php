<?php
/**
 * Use the page slug "chandlers-vacancies"
 */
 ?>

<?php get_header(); ?>

  <?php get_template_part( 'template-parts/group/chandlers-header' ); ?>

  <div class="pbs-breadcrumb">
    <nav class="container-fluid">
      <ul>
        <li><a href="https://chandlersbs.co.uk/">Home</a></li>
        <li>/</li>
  ...
  <div class="pbs-vacancies-page">
    <div class="container-fluid">
      ...
      <div class="pbs-content">
        ...
        <h4 class="mb-3 pbs-font pbs-chandlers-heading">Careers</h4>
        <hr>
        <?php
        if ( have_posts() ) :
      ...
      <div class="pbs-group">
        <h4 class="mb-3 pbs-font pbs-chandlers-heading">More opportunities within our group</h4>
        <div class="row">
          <div class="col-md-4">
  ...
  <?php get_template_part( 'template-parts/group/chandlers-footer' ); ?>
